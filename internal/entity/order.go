...
type Order struct {
	...
	InternalSignature string    `json:"internal_signature" gorm:"type:varchar(255)"`
...
type Item struct {
	OrderUID string `json:"-" gorm:"type:varchar(255);primaryKey"`
	Rid      string `json:"rid" validate:"required,alphanumunicode,min=5,max=64" gorm:"type:varchar(255);primaryKey"`
